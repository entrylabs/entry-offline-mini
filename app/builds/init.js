...
/***/ function(module, exports, __webpack_require__) {
	...
	function init() {
	    ...
	    var _require = __webpack_require__(35)("./" + userLang + '.js');
...
/***/ function(module, exports, __webpack_require__) {
	...
	!function (a) {
	  ...
	  "object" == ( false ? "undefined" : _typeof(module)) && "object" == _typeof(module.exports) ? module.exports = a() :  true ? !(__WEBPACK_AMD_DEFINE_FACTORY__ = (a), __WEBPACK_AMD_DEFINE_RESULT__ = (typeof __WEBPACK_AMD_DEFINE_FACTORY__ === 'function' ? (__WEBPACK_AMD_DEFINE_FACTORY__.call(exports, __webpack_require__, exports, module)) : __WEBPACK_AMD_DEFINE_FACTORY__), __WEBPACK_AMD_DEFINE_RESULT__ !== undefined && (module.exports = __WEBPACK_AMD_DEFINE_RESULT__)) : a();
	}(function () {
	        ...
	        function a() {
	          function a(a, b) {
	            ...
	            var u,
	                ...
	                D = parseFloat(h.offset) || 0;h.container ? p.isWrapped(h.container) || p.isNode(h.container) ? (h.container = h.container[0] || h.container, u = h.container["scroll" + A], z = u + m(f).position()[A.toLowerCase()] + D) : h.container = null : (u = t.State.scrollAnchor[t.State["scrollProperty" + A]], w = t.State.scrollAnchor[t.State["scrollProperty" + ("Left" === A ? "Top" : "Left")]], z = m(f).offset()[A.toLowerCase()] + D), i = { scroll: { rootPropertyValue: !1, startValue: u, currentValue: u, endValue: z, unitType: "", easing: h.easing, scrollData: { container: h.container, direction: A, alternateValue: w } }, element: f }, t.debug && console.log("tweensContainer (scroll): ", i.scroll, f);
	          } else if ("reverse" === C) {
	            if (!g(f).tweensContainer) return void m.dequeue(f, h.queue);"none" === g(f).opts.display && (g(f).opts.display = "auto"), "hidden" === g(f).opts.visibility && (g(f).opts.visibility = "visible"), g(f).opts.loop = !1, g(f).opts.begin = null, g(f).opts.complete = null, s.easing || delete h.easing, s.duration || delete h.duration, h = m.extend({}, g(f).opts, h);var E = m.extend(!0, {}, g(f).tweensContainer);for (var F in E) {
	              if ("element" !== F) {
	                var G = E[F].startValue;E[F].startValue = E[F].currentValue = E[F].endValue, E[F].endValue = G, p.isEmptyObject(s) || (E[F].easing = h.easing), t.debug && console.log("reverse tweensContainer (" + F + "): " + JSON.stringify(E[F]), f);
	              }
	            }i = E;
	          } else if ("start" === C) {
	            var E;g(f).tweensContainer && g(f).isAnimating === !0 && (E = g(f).tweensContainer), m.each(q, function (b, c) {
	              if (RegExp("^" + v.Lists.colors.join("$|^") + "$").test(b)) {
	                var e = a(c, !0),
	                    f = e[0],
	                    g = e[1],
	                    h = e[2];if (v.RegEx.isHex.test(f)) {
	                  for (var i = ["Red", "Green", "Blue"], j = v.Values.hexToRgb(f), k = h ? v.Values.hexToRgb(h) : d, l = 0; l < i.length; l++) {
	                    var m = [j[l]];g && m.push(g), k !== d && m.push(k[l]), q[b + i[l]] = m;
	                  }delete q[b];
	                }
	              }
	            });for (var H in q) {
	              var K = a(q[H]),
	                  L = K[0],
	                  M = K[1],
	                  N = K[2];H = v.Names.camelCase(H);var O = v.Hooks.getRoot(H),
...
/***/ function(module, exports, __webpack_require__) {
	...
	EntryStatic.usageList = ['usage_event', 'usage_signal', 'usage_scene', 'usage_repeat', 'usage_condition_repeat', 'usage_condition', 'usage_clone', 'usage_arrow_move', 'usage_rotation', 'usage_coordinate', 'usage_shape', 'usage_speak', 'usage_picture_effect', 'usage_textBox', 'usage_draw', 'usage_sound', 'usage_confirm', 'usage_comp_operation', 'usage_logical_operation', 'usage_math_operation', 'usage_random', 'usage_timer', 'usage_variable', 'usage_list', 'usage_ask_answer', 'usage_function', 'usage_arduino'];
	
	EntryStatic.conceptList = ['concept_resource_analytics', 'concept_individual', 'concept_abstractive', 'concept_procedual', 'concept_automation', 'concept_simulation', 'concept_parallel'];
	
	EntryStatic.subjectList = ['subject_korean', 'subject_mathmatics', 'subject_social', 'subject_science', 'subject_english', 'subject_courtesy', 'subject_music', 'subject_paint', 'subject_athletic', 'subject_progmatic'];
	
	EntryStatic.lectureLevels = [1, 2, 3];
	
	// EntryStatic.lectureLevels = ['level_high', 'level_mid','level_row'];
	
	EntryStatic.lectureGrades = ['e_1', 'e_2', 'e_3', 'e_4', 'e_5', 'e_6', 'm_1', 'm_2', 'm_3', 'general'];
	
	EntryStatic.categoryList = ['category_game', 'category_animation', 'category_media_art', 'category_physical', 'category_etc'];
	...
	EntryStatic.getAllBlocks = function () {
	    return [{
	        ...
	        category: "flow",
	        blocks: ["wait_second", "repeat_basic", "repeat_inf", "repeat_while_true", "stop_repeat", "_if", "if_else", "wait_until_true", "stop_object"]
	    }, {
	        category: "m_dcmotor",
	        blocks: ["neobot_move_for_secs", "neobot_move_for", "neobot_stop_for"]
	    }, {
	        category: "m_diode",
	        blocks: ["neobot_diode_secs_toggle", "neobot_diode_toggle", "neobot_diode_inout_toggle", "neobot_diode_set_output", "neobot_diode_input_value"]
	    }, {
	        category: "m_melody",
	        blocks: ["neobot_melody_note_for"]
	    }, {
	        category: "m_touch",
	        blocks: ["neobot_touch_if", "neobot_touch_if_else", "neobot_touch_value", "neobot_touch_value_boolean"]
	    }, {
	        category: "m_light",
	        blocks: ["neobot_light_value_if", "neobot_light_value_if_else", "neobot_light_value", "neobot_light_value_boolean"]
	    }, {
	        category: "m_sound",
	        blocks: ["neobot_sound_value_if", "neobot_sound_value_if_else", "neobot_sound_value", "neobot_sound_value_boolean"]
	    }, {
	        category: "m_irs",
	        blocks: ["neobot_irs_value_if", "neobot_irs_value_if_else", "neobot_irs_value", "neobot_irs_value_boolean"]
	    }, {
	        category: "m_others",
	        blocks: ["neobot_others_value_if", "neobot_others_value_if_else"]
	    }, {
	        category: "m_remote",
	        blocks: ["when_run_button_click"]
	    }, {
	        category: "m_servo",
	        blocks: ["when_run_button_click", "neobot_set_servo"]
	    }];
	};
	...
	EntryStatic.blockInfo = {
	    ...
	    "boolean_basic_operator": {
	        ...
	        "xmls": ["<block type='boolean_basic_operator'> <field name='OPERATOR'>EQUAL</field> <value name='LEFTHAND'> <block type='text'><field name='NAME'>10</field></block> </value> <value name='RIGHTHAND'> <block type='text'><field name='NAME'>10</field></block> </value> </block>", "<block type='boolean_basic_operator'> <field name='OPERATOR'>GREATER</field> <value name='LEFTHAND'> <block type='text'><field name='NAME'>10</field></block> </value> <value name='RIGHTHAND'> <block type='text'><field name='NAME'>10</field></block> </value> </block>", "<block type='boolean_basic_operator'> <field name='OPERATOR'>LESS</field> <value name='LEFTHAND'> <block type='text'><field name='NAME'>10</field></block> </value> <value name='RIGHTHAND'> <block type='text'><field name='NAME'>10</field></block> </value> </block>", "<block type='boolean_basic_operator'> <field name='OPERATOR'>GREATER_OR_EQUAL</field> <value name='LEFTHAND'> <block type='text'><field name='NAME'>10</field></block> </value> <value name='RIGHTHAND'> <block type='text'><field name='NAME'>10</field></block> </value> </block>", "<block type='boolean_basic_operator'> <field name='OPERATOR'>LESS_OR_EQUAL</field> <value name='LEFTHAND'> <block type='text'><field name='NAME'>10</field></block> </value> <value name='RIGHTHAND'> <block type='text'><field name='NAME'>10</field></block> </value> </block>"],
	    ...
	    "calc_basic": {
	        ...
	        "xmls": ["<block type='calc_basic'> <field name='OPERATOR'>PLUS</field> <value name='LEFTHAND'> <block type='number'><field name='NUM'>10</field></block> </value> <value name='RIGHTHAND'> <block type='number'><field name='NUM'>10</field></block> </value> </block>", "<block type='calc_basic'> <field name='OPERATOR'>MINUS</field> <value name='LEFTHAND'> <block type='number'><field name='NUM'>10</field></block> </value> <value name='RIGHTHAND'> <block type='number'><field name='NUM'>10</field></block> </value> </block>", "<block type='calc_basic'> <field name='OPERATOR'>MULTI</field> <value name='LEFTHAND'> <block type='number'><field name='NUM'>10</field></block> </value> <value name='RIGHTHAND'> <block type='number'><field name='NUM'>10</field></block> </value> </block>", "<block type='calc_basic'> <field name='OPERATOR'>DIVIDE</field> <value name='LEFTHAND'> <block type='number'><field name='NUM'>10</field></block> </value> <value name='RIGHTHAND'> <block type='number'><field name='NUM'>10</field></block> </value> </block>"],
	        "class": "calc",
	        "isNotFor": [],
	        "usage": ["calculation"]
	    },
	    ...
	    "rotate_by_angle_dropdown": {
	        ...
	        "xmls": ["<block type='rotate_by_angle_dropdown'> <field name=\"VALUE\">45</field></block>", "<block type='rotate_by_angle_dropdown'> <field name=\"VALUE\">90</field></block>", "<block type='rotate_by_angle_dropdown'> <field name=\"VALUE\">135</field></block>", "<block type='rotate_by_angle_dropdown'> <field name=\"VALUE\">180</field></block>"],
	        "isNotFor": [],
	        "class": "ebs"
	    },
	    "rotate_by_angle": {
	...
	EntryStatic.objectMainCategories = ['entrybot_friends', 'people', 'animal', 'plant', 'vehicles', 'architect', 'food', 'environment', 'stuff', 'fantasy', 'interface', 'background'];
	...
	EntryStatic.getName = function (str, type) {
	    ...
	    if (type == 'picture') dict = PictureNames;else if (type == 'sound') dict = SoundNames;
